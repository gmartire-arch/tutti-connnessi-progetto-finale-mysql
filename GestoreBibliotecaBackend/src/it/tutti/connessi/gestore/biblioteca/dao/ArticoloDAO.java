        ...
        try (Connection conn = ConnessioneDB.getConnessione();
            ...
            while (rs.next()) {
                ...
                if ("LIBRO".equals(tipo)) {
                    System.out.println("[ID: " + id + "] LIBRO: \"" + titolo + "\" di " + rs.getString("autore") + " [" + stato + "]");
                } else if ("DVD".equals(tipo)) {
                    System.out.println("[ID: " + id + "] DVD: \"" + titolo + "\" (" + rs.getInt("durata_minuti") + " min) [" + stato + "]");
                }
            }
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    if ("LIBRO".equals(tipo)) {
                        ...
                        return new DVD(id, titolo, disponibile, durata);
                    }
                }
            }
        } catch (SQLException e) {
